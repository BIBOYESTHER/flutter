...
class _PersonneState extends State<Personne> {
  ...
  Future<void> AddData() async {
    var url = "http://192.168.43.162/isig_2020/postdata.php";
  ...
  Future<void> DeleteData() async {
    var url = "http://192.168.43.162/isig_2020/delete.php";
    final reponse = await http.post(Uri.parse(url), body: {
      // "nom": txtnom.text,
      // "adresse": txtadresse.text,
      // "telephone": txttelephone.text,
  ...
  Future<void> UpdateData() async {
    var url = "http://192.168.43.162/isig_2020/update.php";
    final reponse = await http.post(Uri.parse(url), body: {
      "nom": txtnom.text,
      "adresse": txtadresse.text,
      "telephone": txttelephone.text,
  ...
  Future<List> getData() async {
    var url = "http://192.168.43.162/isig_2020/getdata.php";
